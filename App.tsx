...
export default class CameraScreen extends React.Component<{}, {}, Camera> {
  state = {
    flash: "off",
    zoom: 0,
    autoFocus: "on",
  ...
  /**
   * Tentatively removing what appears to be a deprecated and unused method
   * @deprecated
   * Refer to:
   *   https://github.com/react-native-community/react-native-camera/pull/2009
   * Old code:
   * ```js
   * getRatios = async () => {
  ...
  renderFace({ bounds, faceID, rollAngle, yawAngle }): JSX.Element {
    return (
      <View
        key={faceID}
        transform={[
